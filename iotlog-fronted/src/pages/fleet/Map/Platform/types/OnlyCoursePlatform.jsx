...
const OnlyCoursePlatform = ({ data, zoom, mapTheme, machines }) => {
  ...
  React.useEffect(() => {
    ...
    socket.emit("join", {
      topics: [`sensorstate_course_${data.code}`],
    });
...
export default connect(mapStateToProps, undefined)(OnlyCoursePlatform);
