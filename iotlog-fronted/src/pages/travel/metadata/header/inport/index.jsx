import { Card, CardHeader, Col, EvaIcon, InputGroup, Row } from "@paljs/ui";
...
const HeaderInPortMetadata = (props) => {
      ...
      <Col breakPoint={{ md: 12 }}>
        <Card>
          ...
          <Row style={{ margin: 0 }}>
            ...
            <ColDate breakPoint={{ md: 4 }} className="mb-4">
              <LabelIcon
            ...
            <ColDate breakPoint={{ md: 4 }} className="mb-4">
              <LabelIcon iconName="navigation-2-outline" title="ETD" />
              <DateTime
                className="mt-1"
                onChangeTime={(value) => onChange("etdTime", value)}
                onChangeDate={(time) => onChange("etdDate", time)}
                min={data?.dateTimeStart}
                date={data?.etdDate}
                time={data?.etdTime}
                breakPointDate={{ md: 7 }}
            ...
            <ColDate breakPoint={{ md: 4 }} className="mb-4">
              ...
              <DateTime
                className="mt-1"
                onChangeTime={(value) =>
                  onChange("dateTimeDepartureTime", value)
                }
                onChangeDate={(value) =>
                  onChange("dateTimeDepartureDate", value)
                }
                breakPointDate={{ md: 7 }}
                breakPointTime={{ md: 5 }}
                min={data?.dateTimeStart}
