...
import { ContainerColor, ContainerRow, InputColor } from "../../../../Inputs";
import TextSpan from "../../../../Text/TextSpan";
import { debounce } from "underscore";
import { LabelIcon } from "../../../../Label";

const TankLiquidOptions = (props) => {
              ...
              <Row key={i} className="pl-4 mb-4">
                <Col breakPoint={{ md: 11 }}>
                  <Row>
                    ...
                    <Col breakPoint={{ md: 3 }} className="mb-2">
                      ...
                      <InputGroup fullWidth>
                        <input
                          ...
                          onChange={(e) =>
                            onChangeItem(i, "maxValue", e.target.value)
                          }
                          type="number"
                    ...
                    <Col breakPoint={{ md: 3 }} className="mb-2">
                      <LabelIcon
                        title={<FormattedMessage id="size.decimals.acron" />}
                        iconName="percent-outline"
                      />
                      <InputGroup fullWidth>
                        <input
                          value={machineItem?.decimals}
                          onChange={(e) =>
                            onChangeItem(i, "decimals", e.target.value)
                          }
                          type="text"
                    ...
                    <Col breakPoint={{ md: 6 }} className="mb-3">
                      <LabelIcon
                    ...
                    <Col breakPoint={{ md: 12 }} className="ml-4 pr-1">
