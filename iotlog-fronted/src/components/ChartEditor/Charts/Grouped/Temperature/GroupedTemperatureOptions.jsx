...
import { InputColor, ContainerColor, ContainerRow } from "../../../../Inputs";
import { debounce } from "underscore";
import { LabelIcon } from "../../../../Label";

const GroupedTemperatureOptions = (props) => {
  ...
  const changeValueDebounced = debounce((index, indexSubItem, prop, value) => {
    onChangeSubItem(index, indexSubItem, prop, value)
  }, 500);
  ...
  return (
    <>
      <ContainerRow>
                ...
                <Col breakPoint={{ md: 11 }}>
                  <Row>
                    ...
                    <Col breakPoint={{ md: 3 }} className="mb-2">
                      <LabelIcon
                        title={<FormattedMessage id="min.value" />}
                        iconName="thermometer-minus-outline"
                      />
                      <InputGroup fullWidth>
                        <input
                          value={machineItem?.minValue}
                          onChange={(e) => onChangeItem(i, "minValue", e.target.value)}
                          type="number"
                    ...
                    <Col breakPoint={{ md: 3 }} className="mb-2">
                      <LabelIcon
                        title={<FormattedMessage id="max.value" />}
                        iconName="thermometer-plus-outline"
                      />
                      <InputGroup fullWidth>
                        <input
                          value={machineItem?.maxValue}
                          onChange={(e) => onChangeItem(i, "maxValue", e.target.value)}
                          type="number"
                    ...
                    <Col breakPoint={{ md: 6 }} className="mb-2">
                      ...
                      <InputGroup fullWidth>
                        <input
                          value={machineItem?.pointers}
                          onChange={(e) => onChangeItem(i, "pointers", e.target.value)}
                          type="text"
                          placeholder={intl.formatMessage({
                            id: "pointers.placeholder",
                          })}
                        />
                      </InputGroup>
                    </Col>
                    <Col breakPoint={{ md: 6 }} className="mb-2">
                      ...
                      <InputGroup fullWidth>
                        <input
                          ...
                          onChange={(e) => onChangeItem(i, "link", e.target.value)}
                          type="text"
                          placeholder={intl.formatMessage({
                            id: "link.open.chart",
                          })}
        ...
        <Col breakPoint={{ md: 4 }} className="mb-4 ml-3">
          <LabelIcon
            title={<FormattedMessage id="color" />}
            iconName="color-palette-outline"
          />
          <ContainerColor>
            ...
            />
            <TextSpan apparence="s1" className="ml-2">
              <FormattedMessage id="color.base" />
            </TextSpan>
          </ContainerColor>
        </Col>
      </ContainerRow>
