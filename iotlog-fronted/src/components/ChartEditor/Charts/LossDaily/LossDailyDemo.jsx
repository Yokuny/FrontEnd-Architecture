...
const LossDailyDemo = (props) => {
  ...
  const options = {
    ...
    title: {
      text: props.intl.formatMessage({ id: "loss.machine" }),
      align: "center",
      style: {
        foreColor: props.theme.textBasicColor,
        fontFamily: props.theme.fontFamilyPrimary,
...
const LossDailyDemoIntl = injectIntl(LossDailyDemo);
export default withTheme(LossDailyDemoIntl);
