          ...
          <div className="absolute top-0 left-0 size-10 cursor-pointer">
            <Popover open={midPopover} onOpenChange={setMidPopover}>
              <PopoverTrigger asChild className="w-full">
                <Button className="absolute top-1/3 left-1/3 h-1/3 w-1/3 rounded-none border-sky-blue/30 p-0 hover:border hover:bg-sky-blue/10" variant="blank" type="button" />
              </PopoverTrigger>
            ...
            <Popover open={leftPopover} onOpenChange={setLeftPopover}>
              <PopoverTrigger asChild className="w-full">
                <Button className="absolute top-0 left-0 h-full w-1/3 rounded-lg border-sky-blue/30 p-0 hover:border hover:bg-sky-blue/10" variant="blank" type="button" />
              </PopoverTrigger>
              <PopoverContent className="w-60">
                <div className="flex flex-col space-y-3">
            ...
            <Popover open={rightPopover} onOpenChange={setRightPopover}>
              <PopoverTrigger asChild className="w-full">
                <Button className="absolute top-0 right-0 h-full w-1/3 rounded-lg border-sky-blue/30 p-0 hover:border hover:bg-sky-blue/10" variant="blank" type="button" />
              </PopoverTrigger>
              <PopoverContent className="w-60">
                <div className="flex flex-col space-y-3">
            ...
            <Popover open={topPopover} onOpenChange={setTopPopover}>
              <PopoverTrigger asChild className="w-full">
                <Button className="absolute top-0 left-0 h-1/3 w-full rounded-lg border-sky-blue/30 p-0 hover:border hover:bg-sky-blue/10" variant="blank" type="button" />
              </PopoverTrigger>
              <PopoverContent className="w-60">
                <div className="flex flex-col space-y-3">
            ...
            <Popover open={bottomPopover} onOpenChange={setBottomPopover}>
              <PopoverTrigger asChild className="w-full">
                <Button className="absolute bottom-0 left-0 h-1/3 w-full rounded-lg border-sky-blue/30 p-0 hover:border hover:bg-sky-blue/10" variant="blank" type="button" />
              </PopoverTrigger>
              <PopoverContent className="w-60">
                <div className="flex flex-col space-y-3">
