    ...
    <div className="grid grid-cols-1 gap-px overflow-hidden rounded-xl border bg-border sm:grid-cols-2 lg:grid-cols-4">
      ...
      <Item className="flex-col rounded-none border-0 bg-background">
        <ItemContent className="flex w-full flex-row items-center justify-between gap-2">
          ...
          <Badge className="rounded-sm border-none bg-amber-100 font-bold text-amber-700">{kpis.openPercent.toFixed(1)}%</Badge>
        </ItemContent>
      ...
      <Item className="flex-col rounded-none border-0 bg-background">
        <ItemContent className="flex w-full flex-row items-center justify-between gap-2">
          ...
          <Badge className="rounded-sm border-none bg-emerald-100 font-bold text-emerald-700">{kpis.closedPercent.toFixed(1)}%</Badge>
        </ItemContent>
      ...
      <Item className="flex-col rounded-none border-0 bg-background">
        <ItemContent className="flex w-full flex-row items-center justify-between gap-2">
          ...
          <Badge className="rounded-sm border-none bg-red-100 font-bold text-red-700">{kpis.expiredPercent.toFixed(1)}%</Badge>
        </ItemContent>
