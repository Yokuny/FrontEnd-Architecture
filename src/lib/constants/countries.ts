...
export const COUNTRIES: Country[] = [
  ...
  { name: 'Bahamas', code: 'BS', code3: 'BHS', numeric: '044' },
  ...
  { name: 'Bolivia (Plurinational State of)', code: 'BO', code3: 'BOL', numeric: '068' },
  ...
  { name: 'British Indian Ocean Territory', code: 'IO', code3: 'IOT', numeric: '086' },
  ...
  { name: 'Cayman Islands', code: 'KY', code3: 'CYM', numeric: 136 },
  { name: 'Central African Republic', code: 'CF', code3: 'CAF', numeric: 140 },
  ...
  { name: 'Cocos (Keeling) Islands', code: 'CC', code3: 'CCK', numeric: 166 },
  { name: 'Colombia', code: 'CO', code3: 'COL', numeric: 170 },
  { name: 'Comoros', code: 'KM', code3: 'COM', numeric: 174 },
  { name: 'Congo (the Democratic Republic of the)', code: 'CD', code3: 'COD', numeric: 180 },
  { name: 'Congo', code: 'CG', code3: 'COG', numeric: 178 },
  { name: 'Cook Islands', code: 'CK', code3: 'COK', numeric: 184 },
  ...
  { name: 'Dominican Republic', code: 'DO', code3: 'DOM', numeric: 214 },
  ...
  { name: 'Falkland Islands [Malvinas]', code: 'FK', code3: 'FLK', numeric: 238 },
  { name: 'Faroe Islands', code: 'FO', code3: 'FRO', numeric: 234 },
  ...
  { name: 'French Southern Territories', code: 'TF', code3: 'ATF', numeric: 260 },
  { name: 'Gabon', code: 'GA', code3: 'GAB', numeric: 266 },
  { name: 'Gambia', code: 'GM', code3: 'GMB', numeric: 270 },
  ...
  { name: 'Heard Island and McDonald Islands', code: 'HM', code3: 'HMD', numeric: 334 },
  { name: 'Holy See', code: 'VA', code3: 'VAT', numeric: 336 },
  ...
  { name: 'Iran (Islamic Republic of)', code: 'IR', code3: 'IRN', numeric: 364 },
  ...
  { name: "Korea (the Democratic People's Republic of)", code: 'KP', code3: 'PRK', numeric: 408 },
  { name: 'Korea (the Republic of)', code: 'KR', code3: 'KOR', numeric: 410 },
  { name: 'Kuwait', code: 'KW', code3: 'KWT', numeric: 414 },
  { name: 'Kyrgyzstan', code: 'KG', code3: 'KGZ', numeric: 417 },
  { name: "Lao People's Democratic Republic", code: 'LA', code3: 'LAO', numeric: 418 },
  ...
  { name: 'Marshall Islands', code: 'MH', code3: 'MHL', numeric: 584 },
  ...
  { name: 'Micronesia (Federated States of)', code: 'FM', code3: 'FSM', numeric: 583 },
  { name: 'Moldova (the Republic of)', code: 'MD', code3: 'MDA', numeric: 498 },
  ...
  { name: 'Netherlands', code: 'NL', code3: 'NLD', numeric: 528 },
  ...
  { name: 'Niger', code: 'NE', code3: 'NER', numeric: 562 },
  ...
  { name: 'Northern Mariana Islands', code: 'MP', code3: 'MNP', numeric: 580 },
  ...
  { name: 'Philippines', code: 'PH', code3: 'PHL', numeric: 608 },
  ...
  { name: 'Republic of North Macedonia', code: 'MK', code3: 'MKD', numeric: 807 },
  { name: 'Romania', code: 'RO', code3: 'ROU', numeric: 642 },
  { name: 'Russian Federation', code: 'RU', code3: 'RUS', numeric: 643 },
  ...
  { name: 'Saint Helena, Ascension and Tristan da Cunha', code: 'SH', code3: 'SHN', numeric: 654 },
  { name: 'Saint Kitts and Nevis', code: 'KN', code3: 'KNA', numeric: 659 },
  { name: 'Saint Lucia', code: 'LC', code3: 'LCA', numeric: 662 },
  { name: 'Saint Martin (French part)', code: 'MF', code3: 'MAF', numeric: 663 },
  { name: 'Saint Pierre and Miquelon', code: 'PM', code3: 'SPM', numeric: 666 },
  { name: 'Saint Vincent and the Grenadines', code: 'VC', code3: 'VCT', numeric: 670 },
  ...
  { name: 'Sint Maarten (Dutch part)', code: 'SX', code3: 'SXM', numeric: 534 },
  ...
  { name: 'South Georgia and the South Sandwich Islands', code: 'GS', code3: 'SGS', numeric: 239 },
  ...
  { name: 'Sudan', code: 'SD', code3: 'SDN', numeric: 729 },
  ...
  { name: 'Taiwan (Province of China)', code: 'TW', code3: 'TWN', numeric: 158 },
  { name: 'Tajikistan', code: 'TJ', code3: 'TJK', numeric: 762 },
  { name: 'Tanzania, United Republic of', code: 'TZ', code3: 'TZA', numeric: 834 },
  ...
  { name: 'Turks and Caicos Islands', code: 'TC', code3: 'TCA', numeric: 796 },
  ...
  { name: 'United Arab Emirates', code: 'AE', code3: 'ARE', numeric: 784 },
  { name: 'United Kingdom of Great Britain and Northern Ireland', code: 'GB', code3: 'GBR', numeric: 826 },
  { name: 'United States Outlying Islands', code: 'UM', code3: 'UMI', numeric: 581 },
  { name: 'United States of America', code: 'US', code3: 'USA', numeric: 840 },
  ...
  { name: 'Venezuela (Bolivarian Republic of)', code: 'VE', code3: 'VEN', numeric: 862 },
  { name: 'Viet Nam', code: 'VN', code3: 'VNM', numeric: 704 },
  { name: 'Virgin Islands (British)', code: 'VG', code3: 'VGB', numeric: '092' },
