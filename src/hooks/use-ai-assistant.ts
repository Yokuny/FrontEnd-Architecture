...
import { NavigationAgent, type NavigationResult } from '@/components/ai-prompt/ai/navigationAgent';
import type { RouteGraph, RouteIndex, RouteSemantic } from '@/components/ai-prompt/ai/types';
