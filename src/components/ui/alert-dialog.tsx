...
function AlertDialogAction({ className, variant = 'default', size = 'default', ...props }: ComponentProps<typeof AlertDialogPrimitive.Action> & VariantProps<typeof btnVars>) {
