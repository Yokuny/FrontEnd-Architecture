...
import { Button, btnVars } from './button';
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(btnVars({ variant: buttonVariant }), 'size-(--cell-size) select-none p-0 aria-disabled:opacity-50', defaultClassNames.button_previous),
        button_next: cn(btnVars({ variant: buttonVariant }), 'size-(--cell-size) select-none p-0 aria-disabled:opacity-50', defaultClassNames.button_next),
        ...
        caption_label: cn(
          ...
          captionLayout === 'label' ? 'text-sm' : 'flex h-8 items-center gap-1 rounded-md px-4 text-sm [&>svg]:text-muted-foreground',
