...
export interface ScanTextIconProps extends HTMLAttributes<HTMLButtonElement> {
  size?: number;
}
...
export const ScanTextIcon = forwardRef<ScanTextIconHandle, ScanTextIconProps>(({ onMouseEnter, onMouseLeave, className, size = 20, ...props }, ref) => {
