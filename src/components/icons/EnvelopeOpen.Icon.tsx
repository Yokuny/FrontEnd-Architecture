...
export interface EnvelopeOpenIconProps extends HTMLAttributes<HTMLButtonElement> {
  size?: number;
}
...
export const EnvelopeOpenIcon = forwardRef<EnvelopeOpenIconHandle, EnvelopeOpenIconProps>(({ onMouseEnter, onMouseLeave, className, size = 20, ...props }, ref) => {
