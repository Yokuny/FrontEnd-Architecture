...
const MessageSquareMoreIcon = forwardRef<MessageSquareMoreIconHandle, MessageSquareMoreIconProps>(({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
...
interface MessageSquareMoreIconProps extends HTMLAttributes<HTMLButtonElement> {
  size?: number;
}
