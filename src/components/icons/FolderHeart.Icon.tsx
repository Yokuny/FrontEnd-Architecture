...
const FolderHeartIcon = forwardRef<FolderHeartIconHandle, FolderHeartIconProps>(({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
  ...
  return (
    <div className={cn(className)} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} role="img" aria-label="Folder Heart Icon" {...props}>
      <svg
        fill="none"
        height={size}
        stroke="currentColor"
